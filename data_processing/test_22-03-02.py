...
def mag_psi_vs_opti_psi(takes):
    ...
    transformed_mag = transform_mag_to_control_frame(ac_data)
...
def my_holt_winters(data_arr, alpha, beta, gamma, season_l):
    # Initialization
    st = data_arr[0]
    hw = [st]
    seasonal_arr = [.01] * season_l  # 0.01
    bt = 0
...
if __name__ == "__main__":
    ...
    # mag_psi_vs_opti_psi(take_files)
